...
dual_fullft_model_path="${ARM_HAND_TELEOP_DUAL_PI05_FULLFT_MODEL:-$HOME/workspace/mymodels/agi_arm_bot/pi05_o10_dual_arm_collaborative_express_parcel_sorting_fullft/pretrained_model}"
infer_config="${ARM_HAND_TELEOP_DUAL_PI05_FULLFT_INFER_CONFIG:-$arm_hand_teleop_repo_root/configs/dual_arm/o10_dual_pi05_fullft_infer.yaml}"
...
use_async="${ARM_HAND_TELEOP_DUAL_PI05_FULLFT_ASYNC:-1}"
default_task="${ARM_HAND_TELEOP_DUAL_PI05_FULLFT_DEFAULT_TASK:-dual arm collaborative express parcel sorting}"
...
infer_args=(
  ...
  --yaml "$infer_config"
  --policy pi05
  --model_path "$dual_fullft_model_path"
