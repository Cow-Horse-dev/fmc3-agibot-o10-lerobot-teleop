...
def test_dual_arm_robot_source_uses_cached_tactile_reads():
    ...
    assert "read_tactile_avg_cached()" in source
    assert "read_tactile_fingertip_cached()" in source
...
def test_agibot_hand_source_defines_cached_tactile_helpers():
    ...
    assert "def read_tactile_avg_cached(" in source
    assert "def read_tactile_fingertip_cached(" in source
