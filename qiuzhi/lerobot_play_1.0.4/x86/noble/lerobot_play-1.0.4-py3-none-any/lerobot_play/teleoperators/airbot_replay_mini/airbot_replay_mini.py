...
from lerobot_play.teleoperators.airbot_replay_mini.config_replay_mini import (
    AirbotReplayMiniConfig,
)

logger = logging.getLogger(__name__)


class AirbotReplayMini(Teleoperator):
    config_class = AirbotReplayMiniConfig
    name = "airbot_replay_mini"

    def __init__(self, config: AirbotReplayMiniConfig):
    ...
    def get_action(self):
        ...
        action_dict = {
            ...
            "joint5.pos": -action[4],
            "joint6.pos": action[5],
            "eef.pos": max(0.0, min(abs(action[6]) * (0.072 / 0.01), 0.072)),
        }
