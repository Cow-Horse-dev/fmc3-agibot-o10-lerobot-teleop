...
from lerobot_play.teleoperators.airbot_tok2_leader.config_TOK2_leader import (
    AirbotTOK2LeaderConfig,
)

logger = logging.getLogger(__name__)


class AirbotTOK2Leader(Teleoperator):
    config_class = AirbotTOK2LeaderConfig
    name = "airbot_TOK2_leader"

    def __init__(self, config: AirbotTOK2LeaderConfig):
